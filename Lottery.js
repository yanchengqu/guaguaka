 ...
 */
function Lottery(node, cover, coverType, width, height, drawPercentCallback,clearAll) {
    //canvas
    this.conNode = node;
    ...
    init: function (lottery, lotteryType) {
        ...
        if(this.vail){
            this.background = this.background || this.createElement('canvas', {
                style: 'position:fixed;left:50%;top:0;width:'+ this.width +'px;margin-left:'+ this.width/2 +'px;height:100%;background-color:transparent;'
            });
        }
